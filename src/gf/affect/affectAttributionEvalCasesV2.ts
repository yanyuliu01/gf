...
const PLACEBO_ATTENTION_TEXT: Record<string, string> = {
  VA05: "灌溉管路传来一次很轻的断续异响，但当前流量仍在正常范围",
  VA06: "隔离区门锁指示灯出现一次黄色闪烁，但随后恢复绿色",
  VA07: "机器人转弯时传来一次明显振动声，但下一次转弯没有重复",

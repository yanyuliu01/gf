...
├── docs/            ← 产品、机制、世界观与实施文档
    ...
    ├── 17-cognitive-wake-token-energy-v1.md ← Wake Gate + token 认知精力经济
